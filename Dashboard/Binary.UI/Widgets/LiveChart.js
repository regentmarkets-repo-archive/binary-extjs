									...
									[
										...
										},
										{
											...
											listeners:
											{
												hide: function (obj)
												{
													//Ext.ComponentQuery.query('[name=contract_buy_panel]')[0].down('button').barrier_high_offset = 'S0P'
													//Ext.ComponentQuery.query('[name=contract_buy_panel]')[0].down('button').barrier_low_offset = 'S0P'
												}
											},
											items: [
											{
