...
Binary.Api.Methods =
{
	...
	GetfrxAUDJPYSymbolTicks: "GetfrxAUDJPYSymbolTicks",
...
window.Binary.Api.ClientClass = function ()
{
	...
	this.GetfrxAUDJPYSymbolTicks = function (callback, interval)
	{
		this.Listeners["GetfrxAUDJPYSymbolTicks"] = callback;
		postMsg({}, interval, "GetfrxAUDJPYSymbolTicks", this.Widget.id);
	};
